...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /* Barra di avanzamento + back to top (come la home) */
  ...
  /* Contenuti delle 5 pagine (testo + immagine) */
  const contenuti = {
    azione1: {
      ...
      dato: "Idea immagine: stalla moderna pulita / veterinario con bovini / cura e controllo in allevamento."
    },
    ...
    azione2: {
      ...
      dato: "Idea immagine: razione alimentare / mangime / alimentazione in stalla."
    },
    ...
    azione3: {
      ...
      dato: "Idea immagine: campo coltivato / suolo / agricoltura (immagine pulita e luminosa)."
    },
    ...
    azione4: {
      ...
      dato: "Idea immagine: tablet/sensori in stalla / controllo dati / monitoraggio allevamento."
    },
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  /* ✅ Animazione degli elementi quando entrano nello schermo (mancava!) */
